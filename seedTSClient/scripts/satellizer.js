    ...
    .factory('satellizer.popup', [
        ...
        function ($q, $interval, $window, $location, utils) {
            ...
            popup.open = function (url, options) {
                ...
                //popupWindow = window.open('', '_blank', optionsString);
            ...
            popup.pollPopup = function () {
                ...
                polling = $interval(function () {
                    try {
                        ...
                        //console.log("popupWindow.location.search:" + popupWindow.location.search);
                        //console.log("popupWindow.location.hash:" + popupWindow.location.hash);
